---
name: code_assist:code_review_frontend
description: Force frontend code-review variant (skip stack detection)
...
<objective>
Run the code-review workflow with the **frontend** variant. Skip stack detection.
</objective>
